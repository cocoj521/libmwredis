...
#ifndef __MWREDISIMPL_H__
#define __MWREDISIMPL_H__
#include <stdlib.h>
#include <stdio.h>
#include <string>
#include <map>
...
class MWRedisRedisImpl : public MWRedisClient
{
public:
    MWRedisRedisImpl();
    virtual ~MWRedisRedisImpl();
...
public:
    ...
    *  @return 0:成功; <0:错误码
    ************************************************************************/
    virtual int hmset(const std::string& key, const std::map<std::string, std::string>& kvmap, std::string& error);
    ...
    ************************************************************************/
    virtual int hset(const std::string& key, const std::string& name, const std::string& value, std::string& error);
    ...
    *  @return 0:成功; <0:错误码
    ************************************************************************/
    virtual int hmget(const std::string& key, const std::vector<std::string>& names, std::map<std::string, std::string>& kvmap, std::string& error);
    ...
    */
    virtual int hget(const std::string& key, const std::string& name, std::string& result, std::string& error);
    ...
    *  @return 0:成功; <0:错误码
    ************************************************************************/
    virtual int hgetall(const std::string& key, std::map<std::string, std::string>& kvmap, std::string& error);
    ...
    */
    virtual int hdel(const std::string& key, const std::string& first_name, std::string& error);
    ...
    */
    virtual int hlen(const std::string& key, std::string& error);
    ...
    */
    virtual int hincrby(const std::string& key, const std::string& name, const long long int& inc, long long int* result, std::string& error);
...
public:
    ...
    */
    virtual int lpush(const char* key, const std::vector<std::string>& values, std::string& error);
    ...
    */
    virtual int rpush(const char* key, const std::vector<std::string>& values, std::string& error);
    ...
    */
    virtual int lpop(const char* key, std::string& buf, std::string& error);
    ...
    *      by the key, or the list specified by key is empty
    */
    virtual int rpop(const char* key, std::string& buf, std::string& error);


    virtual int lrange(const char* key, int start, int end, std::vector<std::string>& result, std::string& error);
...
public:
    ...
    */
    virtual int smembers(const std::string& key, std::vector<std::string>& result, std::string& error);
    ...
    */
    virtual int srem(const char* key, const std::vector<std::string>& members, std::string& error);
    ...
    *  非集合对象
    */
    virtual int sismember(const std::string& key, const std::string& member, std::string& error);
    ...
    */
    virtual int scard(const char* key, std::string& error);
...
public:
    ...
    */
    virtual int zcard(const char* key, std::string& error);
    ...
    */
    virtual int zcount(const char* key, double min, double max, std::string& error);
...
public:
    ...
    *  @return true:成功; false:失败
    ************************************************************************/
    virtual bool get(const std::string& key, std::string& value, std::string& error);
...
public:
    ...
    ************************************************************************/
    virtual bool rename_key(const char* key, const char* newkey, std::string& error);
    ...
    *       error happened
    ************************************************************************/
    virtual int pexpire(const char* key, int n, std::string& error);
    ...
    *       error happened
    */
    virtual int expire(const char* key, int n, std::string& error);
    ...
    ************************************************************************/
    virtual bool exists(const char* key, std::string& error);
    ...
    *
    ************************************************************************/
    virtual int del(const std::vector<std::string>& keys, std::string& error);
    ...
    */
    virtual bool incrby(const std::string& key, const long long int& inc, long long int* result, std::string& error);
...
private:
    std::mutex m_sliceMutex;
    std::unordered_map<std::string, std::shared_ptr<MWRedisSliceList>> m_sliceTopicMap;
};




#endif // __MWREDISIMPL_H__